/* #include "TempIndexationAgent.hpp"

// #include "keynodes/InterfaceKeynodes.hpp"
#include <sc-agents-common/utils/IteratorUtils.hpp>

using namespace IndexationModule;

TempIndexationAgent::TempIndexationAgent()
{
  m_logger = utils::ScLogger(
      utils::ScLogger::ScLogType::File, "logs/TempIndexationAgent.log", utils::ScLogLevel::Debug, true);
}

ScResult TempIndexationAgent::DoProgram(ScActionInitiatedEvent const & event, ScAction & action)
{
...
ScAddr TempIndexationAgent::GetActionClass() const
{
  return InterfaceKeynodes::action_change_interface;
}

std::string TempIndexationAgent::createColor()
{
...
bool TempIndexationAgent::setComponentColor(ScAddr const & componentAddr, std::string const & componentColor)
{
  bool result = false;
