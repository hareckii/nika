...
- **Агенты** - *описание агентов в системе NIKA*
    ...
    - [Агент классификации темы сообщения с помощью Wit.ai](agents/messageTopicClassificationAgent.md) - *определяет тему сообщений пользователя при помощи Wit.ai*
    ...
    - [Агент классификации темы сообщения с помощью Rasa](agents/rasaMessageTopicClassificationAgent.ru.md) - *определяет тему сообщений пользователя при помощи Rasa*
