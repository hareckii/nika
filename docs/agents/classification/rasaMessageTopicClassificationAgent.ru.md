# Агент классификации темы сообщения с помощью Rasa
...
```json
{
    ...
    "intent":
    {
        "name":"concept_message_about_entity",
        "confidence":1.0
    },
    "entities":
    [{
        ...
        "start":10,
        "end":14,
        "confidence_entity":0.9997850060462952,
        "value":"Ника",
        "extractor":"DIETClassifier"
    }],
    "text_tokens":[[0,3],[4,9],[10,14]],
    "intent_ranking":
    [
        {
            "name":"ask_definition",
        ...
        {
            "name":"goodbye",
            "confidence":2.69290423293711e-10
        },
        {
            "name":"greet",
            "confidence":1.639179937618085e-11
        }
    ]
}
```
...
2. `concept_message_about_skill`
3. `concept_message_about_subdividing`
4. `concept_message_about_weather`
5. `concept_color_message`
